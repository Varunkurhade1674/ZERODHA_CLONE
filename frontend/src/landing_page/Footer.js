...
function Footer() {
  return (
    ...
    <div className="container border-top mt-4 p-5">
      ...
      <div className="mt-5 text-small "style={{fontSize:"13px"}}>
      <p className="text-muted ">
      ...
      <p className="text-muted ">
        ...
        <p className="text-muted "> India's largest broker based on networth as per NSE.
        <a href="" style={{ textDecoration: "none" }}>
          {" "}
      ...
      <div
        ...
        style={{  display: "flex", justifyContent:"center", gap: "28px", flexWrap: "wrap"  }}>
        <a href="#" className="text-muted" style={{ textDecoration: "none",}}>
          NSE
        </a>
        <a href="#" className="text-muted" style={{ textDecoration: "none" }}>
